...
\begin{itemize}
    ...
    \item We release an \textbf{auditable citation coverage workflow} from 318 collected references, including in-scope grouping and explicit exclusion reasons.
\end{itemize}
