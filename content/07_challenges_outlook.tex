...
\subsection{Near-Term Research Priorities (Abstract-Driven)}

Synthesizing recurring claims in recent abstracts, we identify three near-term priorities:
\begin{itemize}
    \item \textbf{Disentangled diagnostic evaluation:} shift from monolithic benchmark scores to concept-isolated physical diagnostics and reasoning-action faithfulness checks \citep{upadhyay_worldbench_2026,wu_what_2026}.
    \item \textbf{Action-world alignment under embodiment constraints:} improve coordinate-to-pixel and language-to-control alignment using geometry-aware conditioning and consistency objectives \citep{chen_bridgev2w_2026,wang_unified_2025,chen_conrft_2025}.
    \item \textbf{Scalable but safe adaptation loops:} combine synthetic or world-model-generated data with intervention-aware online refinement to improve robustness without uncontrolled exploration cost \citep{team_gigaworld-0_2025,team_gigabrain-0_2025,intelligence__06_2025,li_vla-rft_2025}.
\end{itemize}
